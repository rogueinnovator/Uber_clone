...
interface Props {
  ...
  ridePopUpRef: React.RefObject<HTMLDivElement>;
  setConfirmRide: React.Dispatch<SetStateAction<boolean>>;
}
const RidePopUp: React.FC<Props> = (props) => {
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center gap-2">
        <div className="flex flex-row justify-around items-center bg-yellow-300 py-3 w-full rounded-xl gap-4">
          <img
        ...
        <button
          ...
          className="w-full bg-green-400 py-3 rounded-xl text-white font-semibold"
        >
          Accept
        </button>
        <button
          onClick={() => props.setRidePopUp(false)}
          className="w-full bg-gray-400 py-3 rounded-xl text-white font-semibold"
        >
          ignore
        </button>
      </div>
